...
const VektorText = ({ get, fill, width, height }: { get: number, fill: string, width: number, height: number }) => {
    const paths = [
        <svg key="svg-0" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg key="svg-1" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg key="svg-2" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg key="svg-3" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg key="svg-4" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg key="svg-5" width={width} height={height} viewBox="0 0 121 122" fill="none" xmlns="http://www.w3.org/2000/svg">
